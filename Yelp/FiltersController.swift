...
@objc protocol FiltersControllerDelegate {
    optional func filtersController(filterVC: FiltersController, didUpdateFilter filter: [String])
}

class FiltersController: UIViewController, UITableViewDelegate, UITableViewDataSource, SwitchCellDelegate {
...
//        }
    ...
    @IBAction func onSearch(sender: UIBarButtonItem) {
        ...
        for (row, isSelected) in switchStates {
            ...
            if filters.count > 0{
                delegate?.filtersController!(self, didUpdateFilter: filters)
            }
